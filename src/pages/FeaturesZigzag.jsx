      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="py-12 md:py-20">
          ...
          <div id="projectssection" className="grid gap-20">
            <Link to='https://corbenykt.github.io/fozzy' className='relative flex flex-col items-center'>
              {/* Fozzy's page */}
            ...
            <Link to='https://www.andreychikachev.ru' className='relative flex flex-col items-center'>
              <div className="md:grid md:grid-cols-12 md:gap-6 items-center">
                {/* Image */}
            ...
            {/* 3rd item */}
            <Link to='https://corbenykt.github.io/currencycalculator' className='relative flex flex-col items-center'>
              <div className="md:grid md:grid-cols-12 md:gap-6 items-center">
                {/* Image */}
                <div className="max-w-xl md:max-w-none md:w-full mx-auto md:col-span-5 lg:col-span-6 mb-8 md:mb-0 md:order-1" data-aos="fade-up">
